...
import {
  ...
  Database, Robot, Plugs, Gear, Pulse,
...
export default function Sidebar() {
  return (
    <div data-testid="sidebar" className="flex flex-col h-full">
      <div className="px-4 py-4 border-b border-[#222] flex items-center gap-2">
        <div className="w-7 h-7 bg-[#00E676] flex items-center justify-center" style={{ fontFamily: "Chivo", fontWeight: 900, color: "#000", fontSize: 14 }}>A</div>
        <div>
          <div style={{ fontFamily: "Chivo", fontWeight: 900, fontSize: 14, letterSpacing: "-0.02em" }}>ALGONID</div>
          <div className="dim text-[10px] uppercase tracking-widest mono">trading terminal</div>
        </div>
      </div>
